...
Bei den berechneten Werten für den Phasenverschiebungswinkel und der Übertragungsfunktion (Abb. \ref{tab:werte_fluke_oszi}) ist der wahre Frequentiert zwischen 2500Hz und 2800Hz. Für den Wert von 2500Hz haben wir die Gesuchten -3dB für A und bei rund 2800Hz die 45Grad für den Winkel.\\
Die Messung von A ergab durch lineare Regression (Abb. \ref{fig:betraga_linfit}) der anfänglichen Steigung eine Abweichung von 1 um rund 0.04 (Abb. \ref{fig:betraga_abweichung}) was 4\% entspricht.\\
