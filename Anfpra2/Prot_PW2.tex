...
\begin{figure}[H]
	...
	\caption{v(t) und a(t) Diagramm einer kräftefreien Bewegung}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.29]{./figure/phi(t)_diagram_freie_bew.png}
	\caption{phi(t) Änderung des Winkels des Außenstiftes zur Schwerpunktsbewegung mit der Zeit}
	\label{fig:phi_t_freie_bew}
\end{figure}

$\omega = (-232.2 \pm 0.2)^\circ/s$\\
\\
...
\\
Ähnliches gilt für die Winkelgeschwindigkeit, die in erster Näherung konstant ist, jedoch leicht abnimmt mit der Zeit. Zu Beginn der Bewegung ist die Winkelgeschwindigkeit etwa $-232^\circ/s$ (Abb.\ref{fig:phi_t_freie_bew}).\\
