...
From x = 3,0108722000000e+01 to x = 4,9908854000000e+01\\
A = 9,6818262123320e-03 +/- 1,2866119481322e-04\\
B = -2,7619963927231e-01 +/- 5,2008879239489e-03\\
\\
$Chi^2/doF$ = 5,5172355389895e-05\\
$R^2$ = 0,9829880187942\\
Adjusted $R^2$ = 0,9826372562951\\
RMSE (Root Mean Squared Error) = 0,007427809595695\\
RSS (Residual Sum of Squares) = 0,00540689082821\\
...
Folgende Werte wurden nach der lineare Regression mit der Funktion: A*x+B von QTi-Plot errechnet:\\
B (y-intercept) = 1,4040038166667e+00 +/- 2,1583706743270e-02\\
A (slope) = 4,0303792424242e-03 +/- 3,4785293085032e-04\\
Chi^2/doF = 9,9826370738457e-04\\
R^2 = 0,9437592974708\\
Adjusted R^2 = 0,9276905253197\\
RMSE (Root Mean Squared Error) = 0,03159531147788\\
RSS (Residual Sum of Squares) = 0,007986109659077\\
Die Ergebnisse sind in Abbildung \ref{fig:fahrradp} ersichtlich.
\section{Quellen}
